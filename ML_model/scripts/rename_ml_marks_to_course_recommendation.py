"""
One-time: rename MongoDB collection ml_student_course_marks -> course_recommendation.

Run from repo root after pulling the rename (keeps existing documents and indexes where possible):

  python ML_model/scripts/rename_ml_marks_to_course_recommendation.py
"""
